/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cd4de195a68a05996d08f45409e40995)
// Runtime types generated with workerd@1.20260708.1 2025-02-16
interface __BaseEnv_Env {
	DB: D1Database;
	FORWARD_TO_ADDRESS: string;
	EMAIL_PREFIX: string;
	TLD_TAG: Record<string, string>;
	ADDRESS_TAG: Record<string, string>;
	DISCORD_CLIENT_ID: string;
	DISCORD_GUILD_ID: string;
	DISCORD_CHANNEL_ID: string;
	DISCORD_BOT_TOKEN: string;
	DISCORD_PUBLIC_KEY: string;
	DISCORD_EMBED_LIMIT: number;
